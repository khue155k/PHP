    ...
    <div class='flex-sb'>
        ...
        <div class="right flex-grow-1">
            ...
            <div class="container-body pad-12-0">
                <h1 class='title'>Danh sách các chuyến tham quan đã đăng ký</h1>
                            ...
                            if (mysqli_num_rows($getTourFuture) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($getTourFuture)) {
                                    ...
                                    <form method='POST' class='form-inline'>
                                        <input type='hidden' name='tourIDToDelete' value='" . $row['tourID'] . "'>
                                        <button type='submit' class='delete' name='deleteTour'>Hủy đăng ký</button>
                                    </form>
                                    </td>";
                                    echo "</tr>";
                                }
                                ...
                                echo "<tr>";
                                echo "<td colspan='9' class='text-center'>Bạn chưa đăng ký chuyến tham quan nào cả</td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
