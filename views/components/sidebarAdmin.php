            ...
            <div class="sidebar-nav">
                <ul>
                    <li>
                        ...
                        <a href="/PHP_Nhom3/controllers/AdminController.php">Trang chủ</a>
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
